<template>
  <div
    ...
    class="bg-panel rounded-lg border border-line p-3 cursor-pointer hover:shadow-md transition-shadow"
  >
    <p class="font-semibold text-sm text-ink truncate">{{ application.company_name }}</p>
