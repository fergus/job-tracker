...
export function uploadCV(id, file) {
    ...
    return api
        .post(`/applications/${id}/cv`, formData, {
            headers: { "Content-Type": "multipart/form-data" },
        })
        .then((r) => r.data);
}
...
export function uploadCoverLetter(id, file) {
    ...
    return api
        .post(`/applications/${id}/cover-letter`, formData, {
            headers: { "Content-Type": "multipart/form-data" },
        })
        .then((r) => r.data);
}
...
export function createNote(appId, { stage, content }) {
    return api
        .post(`/applications/${appId}/notes`, { stage, content })
        .then((r) => r.data);
}

export function updateNote(appId, noteId, { content, stage }) {
    return api
        .put(`/applications/${appId}/notes/${noteId}`, { content, stage })
        .then((r) => r.data);
}
...
export function uploadAttachments(appId, files) {
    ...
    return api
        .post(`/applications/${appId}/attachments`, formData, {
            headers: { "Content-Type": "multipart/form-data" },
        })
        .then((r) => r.data);
}
...
export function deleteAttachment(appId, attachmentId) {
    return api
        .delete(`/applications/${appId}/attachments/${attachmentId}`)
        .then((r) => r.data);
}
...
export function generateDocument(appId, task) {
    return api
        .post(`/applications/${appId}/generate`, { task })
        .then((r) => r.data);
}
