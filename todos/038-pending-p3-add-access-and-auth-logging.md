...
## Acceptance Criteria
- [ ] Morgan middleware added for HTTP access logs
- [ ] Auth failures logged with IP and reason
- [ ] Admin `?all=true` usage logged with admin email
- [ ] Admin attachment downloads logged with admin email and attachment ID
- [ ] Global error handler logs message + stack without leaking the raw error object
