...
## Acceptance Criteria
- [x] `updated_since` with an invalid date returns HTTP 400 with a clear error message
- [x] Valid ISO 8601 datetime strings continue to work correctly
- [x] Empty/absent `updated_since` still returns all results as before

## Work Log
- 2026-03-25: Created from OWASP Top 10 security review
- 2026-04-21: Implemented in services/applications.js — throws ServiceError(400) for non-parseable dates, consistent with status validation above it
